...
RUN R -e "install.packages(c('highcharter', 'leaflet', 'shinycssloaders', 'shinyjs', 'tmap', 'leaflet.extras', 'plumber', 'uuid', 'curl', 'mailR', 'kableExtra'), repos='https://cran.rstudio.com/');"
